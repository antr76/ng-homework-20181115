...
/* harmony import */ var _items_item_phone_number_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./items/item/phone-number.pipe */ "./src/app/items/item/phone-number.pipe.ts");
...
/* harmony import */ var _items_item_item_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./items/item/item.component */ "./src/app/items/item/item.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _items_item_phone_number_pipe__WEBPACK_IMPORTED_MODULE_6__["PhoneNumberPipe"],
                _nav_nav_component__WEBPACK_IMPORTED_MODULE_8__["NavComponent"],
                _image_image_component__WEBPACK_IMPORTED_MODULE_9__["ImageComponent"],
                _items_item_item_component__WEBPACK_IMPORTED_MODULE_10__["ItemComponent"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]
            ],
            providers: [
                { provide: _app_service__WEBPACK_IMPORTED_MODULE_7__["AppService"], useClass: _app_service__WEBPACK_IMPORTED_MODULE_7__["AppService"] }
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"]
            ]
...
/* harmony import */ var _shared_db_db_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shared/db/db-data */ "./src/app/shared/db/db-data.ts");



var AppService = /** @class */ (function () {
    function AppService() {
        this.filterSubject = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]('all');
        this.selectedItemSubject = new rxjs__WEBPACK_IMPORTED_MODULE_0__["Subject"]();
        this.initialize();
    }
    AppService.prototype.initialize = function () {
        this.configureFilterStream(this.filterSubject, _shared_db_db_data__WEBPACK_IMPORTED_MODULE_2__["allItems$"]);
        this.configureSelectedItemStream(this.filteredItems$, this.selectedItemSubject);
    };
    AppService.prototype.setFilterCriteria = function (itemType) {
        this.filterSubject.next(itemType);
    };
    AppService.prototype.getDistinctFilterItems = function () {
        var _this = this;
        var filterItems;
        var sub = _shared_db_db_data__WEBPACK_IMPORTED_MODULE_2__["allItems$"]
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (items) { return _this.getItemTypes(items); }))
    ...
    AppService.prototype.setItemSelection = function (selectedItem) {
        this.selectedItemSubject.next(selectedItem);
    };
    AppService.prototype.getItemTypes = function (items) {
        return items.map(function (item) { return item.type; });
    };
    AppService.prototype.configureFilterStream = function (filter$, items$) {
        var _this = this;
        var filterCombinedStream$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(filter$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])()), items$, function (itemType, allItems) {
            return { itemType: itemType, allItems: allItems };
        });
        this.filteredItems$ = filterCombinedStream$
            .pipe(
        // tap((data) => console.log('before map: ', data)),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (data) { return _this.filterItems(data.itemType, data.allItems); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (filteredItems) { return console.log('filtered items emitted new value: ', filteredItems); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["shareReplay"])());
    };
    AppService.prototype.configureSelectedItemStream = function (items$, selectedItem$) {
        var _this = this;
        var firstItem$ = items$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (items) { return _this.findItem(0, items); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (firstItem) { return console.log('first item emitted new value: ', firstItem); }));
        this.selectedItem$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"])(firstItem$, selectedItem$)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (selectedItem) { return console.log('selected item emitted new value: ', selectedItem); }));
    };
    AppService.prototype.filterItems = function (itemType, allItems) {
        var filteredItems = allItems.filter(function (item) { return [item.type, 'all'].includes(itemType.toLowerCase()); });
        return filteredItems;
    };
    AppService.prototype.findItem = function (itemIndex, items) {
